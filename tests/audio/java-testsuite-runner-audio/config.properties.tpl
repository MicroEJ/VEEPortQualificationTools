...
# Uncomment one and only one option depending on the audio features supported by the VEE Port.
test.run.includes.pattern=**/_AllTests_*.class
#test.run.includes.pattern=**/_AllTests_AudioRecordTest.class
#test.run.includes.pattern=**/_AllTests_AudioTrackTest.class
...
microej.testsuite.cc.jars.name.regex=audio-.*jar
